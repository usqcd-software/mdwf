...
char *op_a_name = "1";
char *op_b_name = "inverse(mlib:conj(A)) * mlib:conj(A)";
    ...
    const struct QX(Fermion) *s)
{
    ...
    qx(op_A1x)(r->even, &state->even, params, s->even, &flops);
    qx(op_A1x)(r->odd, &state->odd, params, s->odd, &flops);
}
...
operator_b(void)
{
    ...
    Ax(fermion_x, params, fermion_a);
    A1x(fermion_y, params, fermion_x);
