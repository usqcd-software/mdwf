...
char *op_a_name = "<o|lib:1mBA1F|e>";
char *op_b_name = "<o|1mBA1F|e>";
	     ...
	     const struct Fermion *a_y)
{
    ...
    qx(do_1mBA1F)(r_x, 0, xy->body_size, Ls,
    ...
    qx(do_1mBA1F)(r_x, xy->body_size, xy->face_size, Ls,
		  params->BpTable, params->BmTable,
		  params->AipTable, params->AimTable,
...
operator_a(void)
{
    ...
    compute_BA1F(fermion_x->odd, state, params, gauge->data,
