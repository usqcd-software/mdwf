...
static void
compute_A1xBxFx(struct Fermion *r_x,
		...
		const struct Fermion *a_y)
{
    ...
    qx(do_A1xBxFx)(r_x, 0, xy->body_size, Ls,
    ...
    qx(do_A1xBxFx)(r_x, xy->body_size, xy->face_size, Ls,
		   params->AxipTable, params->AximTable,
		   params->BxpTable, params->BxmTable,
...
operator_a(void)
{
    ...
    compute_A1xBxFx(fermion_x->odd, state, params, gauge->data,
		    fermion_a->even);
