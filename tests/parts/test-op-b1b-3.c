...
char *op_a_name = "1";
char *op_b_name = "inverse(mlib:B) * mlib:B";
   ...
   const struct QX(Fermion) *s)
{
    ...
    qx(op_B1)(r->even, &state->even, params, s->even, &flops);
    qx(op_B1)(r->odd, &state->odd, params, s->odd, &flops);
}
