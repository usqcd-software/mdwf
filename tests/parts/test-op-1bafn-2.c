...
static void
compute_BA1Fn(struct Fermion *r_x,
	      double *norm,
	      ...
	      const struct Fermion *a_y)
{
    ...
    n1 = 0;
    qx(do_1mBA1F_norm)(r_x, &n1, 0, xy->body_size, Ls,
    ...
    n2 = 0;
    qx(do_1mBA1F_norm)(r_x, &n2, xy->body_size, xy->face_size, Ls,
		       params->BpTable, params->BmTable,
		       params->AipTable, params->AimTable,
...
operator_a(void)
{
    ...
    compute_BA1Fn(fermion_x->odd, &n, state, params, gauge->data,
