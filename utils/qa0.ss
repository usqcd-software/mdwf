(module qa0
   ...
   (define cmd*
     `(("help"    "             print available commands"        ,do-help)
       ...
       ("cee"     "d/f out in   build .c file for double/float"  ,do-cee)
       ("cee-64"  "d/f out in   build .c file for double/float"  ,do-cee-64)
       ("c99"     "d/f out in   build .c file for double/float"  ,do-c99)
       ("c99-64"  "d/f out in   build .c file for double/float"  ,do-c99-64)
       ("dry"     "d/f out in   build .c file for dry version"   ,do-dry)
       ("bgl/xlc" "d/f out in   build .c file for XLC on BG/L"   ,do-bgl/xlc)
       ("macro"   "d/f out in   do constant folding only"        ,do-macro)
       ("complex" "d/f out in   convert to complex only"         ,do-c-expand)
       ("real"    "d/f out in   convert to real only"            ,do-r-expand)
       ("dhummer" "d/f out in   convert to DH only"              ,do-dhexpand)
